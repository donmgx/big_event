...
import com.hebei.constant.AutoFillConstant;
import com.hebei.context.BaseContext;
...
public class AutoFillAspect {
     ...
     * 切入点
     * */
    @Pointcut("execution(* com.hebei.mapper.*.*(..)) && @annotation(com.hebei.annotation.AutoFill)")
